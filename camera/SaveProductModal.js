...
import { createAssetAsync, createAlbumAsync, getAlbumAsync, addAssetsToAlbumAsync } from 'expo-media-library';
import EventService from '../EventService';
import i18n from '../i18n';

const ALBUM_NAME = "Batch Number";

export default function SaveProductModal({isModalVisible, setModalVisible, photoList, setPhotoList, creationDate}) {
