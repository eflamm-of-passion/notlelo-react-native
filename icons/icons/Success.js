...
export default function Success({ color, width, height }) {
  return (
    <Svg
      width={width ?? 40}
      height={height ?? 40}
      viewBox="0 0 511.755 511.755"
      style="enable-background:new 0 0 511.755 511.755;"
      fill={color ?? "green"}
    >
      <Path
        d="M436.891,74.867c-99.819-99.819-262.208-99.819-362.027,0c-99.819,99.797-99.819,262.229,0,362.027
